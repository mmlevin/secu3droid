...
public class ParamItemSpinner extends BaseParamItem {
	...
	private int index = 0;
	private Spinner paramSpinner = null;
	
	class CustomOnItemSelectedListener implements OnItemSelectedListener {
		final ParamItemSpinner item;
	...
	public void setValue(String value) {
		if (paramSpinner != null) {
			if (value == null) {
				...
				paramSpinner.setAdapter(new ArrayAdapter<>(getContext(), android.R.layout.simple_spinner_item,values));
