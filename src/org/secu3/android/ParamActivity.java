...
public class ParamActivity extends FragmentActivity {
	...
	MyFragment  starterParPage;
	MyFragment anglesParPage;
	MyFragment idlRegParPage;
	MyFragment funsetParPage;
	MyFragment temperParPage;
	MyFragment carburParPage;
	MyFragment adcCorParPage;
	MyFragment ckpsParPage;
	MyFragment miscelParPage;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		pages.add(starterParPage = new MyFragment());
		pages.add(anglesParPage = new MyFragment());
		pages.add(idlRegParPage = new MyFragment());
		pages.add(funsetParPage = new MyFragment());
		pages.add(temperParPage = new MyFragment());
		pages.add(carburParPage = new MyFragment());
		pages.add(adcCorParPage = new MyFragment());
		pages.add(ckpsParPage = new MyFragment());
		pages.add(miscelParPage = new MyFragment());
